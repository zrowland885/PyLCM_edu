...
def model_steering_input():
    ...
    nt_widget      = widgets.IntText(description='nt:', value = 5000, style=style)

    Condensation_widget = widgets.Checkbox(description='Condensation', value=True, style=style)
    Collision_widget = widgets.Checkbox(description='Collision', value=True, style=style)
    
    switch_sedi_removal = widgets.Checkbox(description='Sedimentation removal', value=False, style=style)
    
    n_particles_widget = widgets.BoundedIntText(description='n_particles:', min=100,max = 10000, value=500, style=style)
   
    max_z_widget = widgets.BoundedFloatText(description='z_max (m):', min = 0.0, max = 10000.0, step = 0.1, value=1200.0, style=style)
...
def parcel_info_input():
    ...
    T_widget = widgets.BoundedFloatText(description='T (K):', min = 200.0, max = 320.0, step = 0.1, value=289.27, style=style)
    P_widget = widgets.BoundedFloatText(description='P (Pa):', min = 950.0E2, max = 1050.0E2, step = 1, value=101181, style=style)
    RH_widget= widgets.BoundedFloatText(description='RH (-):', min = 0.01, max = 2.0, step = 0.01, value=0.83, style=style)
...
def grid_modes_input():
    ...
    gridwidget[1, 0] = widgets.BoundedFloatText(description='N_aero (cm⁻3)', min = 0.0, max = 5000.0, step = 0.1, value=200.0, style=style)
    gridwidget[2, 0] = widgets.BoundedFloatText(description='mu (µm)', min = 0.0, max = 5.0, step = 0.001, value=0.04, style=style)
    gridwidget[3, 0] = widgets.BoundedFloatText(description='sigma (-)', min = 0.0, max = 3.0, step = 0.1, value=1.4, style=style)
    gridwidget[4, 0] = widgets.BoundedFloatText(description='Hygroscopicity parameter', min = 0.0, max = 100.0, step = 0.1, value=1.0, style=style)
    
    # Column 1 for mode 2
    gridwidget[0, 1]= widgets.Button(description='Mode #2', disabled=False, button_style='info', tooltip='Heading')
    gridwidget[1, 1] = widgets.BoundedFloatText(description='N_aero (cm⁻3)', min = 0.0, max = 5000.0, step = 0.1, value=0.0, style=style)
    gridwidget[2, 1] = widgets.BoundedFloatText(description='mu (µm)', min = 0.0, max = 5.0, step = 0.001, value=0.0, style=style)
    gridwidget[3, 1] = widgets.BoundedFloatText(description='sigma (-)', min = 0.0, max = 3.0, step = 0.1, value=0.0, style=style)
    gridwidget[4, 1] = widgets.BoundedFloatText(description='Hygroscopicity parameter', min = 0.0, max = 100.0, step = 0.1, value=0.0, style=style)
    # Column 2 for mode 3
    gridwidget[0, 2]= widgets.Button(description='Mode #3', disabled=False, button_style='info', tooltip='Heading')
    gridwidget[1, 2] = widgets.BoundedFloatText(description='N_aero (cm⁻3)', min = 0.0, max = 5000.0, step = 0.01, value=0.0, style=style)
    gridwidget[2, 2] = widgets.BoundedFloatText(description='mu (µm)', min = 0.0, max = 5.0, step = 0.1, value=0.0, style=style)
    gridwidget[3, 2] = widgets.BoundedFloatText(description='sigma (-)', min = 0.0, max = 3.0, step = 0.1, value=0.0, style=style)
    gridwidget[4, 2] = widgets.BoundedFloatText(description='Hygroscopicity parameter', min = 0.0, max = 100.0, step = 0.1, value=0.0, style=style)
    # Column 3 for mode 4
    gridwidget[0, 3]= widgets.Button(description='Mode #4', disabled=False, button_style='info', tooltip='Heading')
    gridwidget[1, 3] = widgets.BoundedFloatText(description='N_aero (cm⁻3)', min = 0.0, max = 5000.0, step = 0.1, value=0.0, style=style)
    gridwidget[2, 3] = widgets.BoundedFloatText(description='mu (µm)', min = 0.0, max = 5.0, step = 0.1, value=0.0, style=style)
    gridwidget[3, 3] = widgets.BoundedFloatText(description='sigma (-)', min = 0.0, max = 3.0, step = 0.1, value=0.0, style=style)
    gridwidget[4, 3] = widgets.BoundedFloatText(description='Hygroscopicity parameter', min = 0.0, max = 100.0, step = 0.1, value=0.0, style=style)
